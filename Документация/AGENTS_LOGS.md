...
**PR:** будет создан автоматически после push
...
3. Подготовил ветку к пушу в staging.

### Результат:
Проблема с генерацией 9:16 в img2img устранена; после push ожидается auto-PR в `staging`.
