...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='boterrorevent',
            index=models.Index(fields=['origin', 'severity', 'occurred_at'], name='botapp_boter_origin_07c32b_idx'),
        ),
        migrations.AddIndex(
            model_name='boterrorevent',
            index=models.Index(fields=['status', 'occurred_at'], name='botapp_boter_status_2a70bc_idx'),
        ),
    ]
