...
async def cmd_start(message: Message, state: FSMContext):
    ...
    welcome_text = (
        ...
        "🖼 Генерация картинок в NanoBanana, GPT, Midjourney\n\n"
        "📹 Генерация видео через Sora, VEO, Kling, Runway\n\n"
        "🔍 Промт по референсу. Скинь в бота ссылку на любой Reels, Shorts, TikTok "
        "и получи промт для генерации точно такого же видео!\n\n"
    ...
    if bonus_tx:
        ...
        bonus_text = (
            ...
            "⚡️Попробуйте прям сейчас! Нажмите на кнопку в меню и выберите что хотите создать 👇"
        )
