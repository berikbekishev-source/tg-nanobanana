...
from webapps.views import midjourney_webapp, midjourney_video_webapp, kling_webapp, kling_v26_webapp, kling_v21_webapp, veo_webapp, sora2_webapp, runway_webapp, runway_aleph_webapp, gpt_image_webapp, nanobanana_webapp
